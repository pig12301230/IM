...
class TextMessageLCell<T: TextMessageCellVM>: MessageBaseLCell<T> {
    ...
    override func updateViews() {
        ...
        self.contentContainerView.snp.remakeConstraints { make in
            let nameHidden = self.viewModel.nameHidden.value
            make.top.equalToSuperview().offset(nameHidden ? 0 : 18)
...
private extension TextMessageLCell {
