//
//  UITapGestureRecognizer+util.swift
//  ChatRoom
//
//  Created by saffi_peng on 2021/4/24.
//
...
extension UITapGestureRecognizer {
    ...
    private func didTapAttributedText(label: UILabel, inRange targetRange: NSRange) -> Bool {
        ...
        if let font = label.font {
            textStorage.addAttribute(.font, value: font, range: NSRange(location: 0, length: attributedText.length))
        }
